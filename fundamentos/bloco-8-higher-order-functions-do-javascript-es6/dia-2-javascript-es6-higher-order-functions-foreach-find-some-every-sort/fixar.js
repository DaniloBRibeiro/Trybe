...
const findNameWithFiveLetters = (str) => str.length === 5;

const fiveNameLetter = names.find(findNameWithFiveLetters);

console.log(fiveNameLetter);
...
const verifyAges = (arr, minimumAge) => {
  //Adicione seu código aqui
  return arr.every((pplage) => pplage.age >= minimumAge);
}
